...
<h2 id="架构全景图" tabindex="-1"><a class="header-anchor" href="#架构全景图" aria-hidden="true">#</a> 架构全景图</h2>
<figure><img src="/assets/img/architecture/hmily-framework.png" alt="架构全景图" tabindex="0" loading="lazy"><figcaption>架构全景图</figcaption></figure>
...
<h3 id="重构部分" tabindex="-1"><a class="header-anchor" href="#重构部分" aria-hidden="true">#</a> 重构部分</h3>
<ul>
<li>
...
<h3 id="解决疑难-bug" tabindex="-1"><a class="header-anchor" href="#解决疑难-bug" aria-hidden="true">#</a> 解决疑难 bug：</h3>
<ul>
...
<h3 id="用户使用与升级指南" tabindex="-1"><a class="header-anchor" href="#用户使用与升级指南" aria-hidden="true">#</a> 用户使用与升级指南</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>hmily:
  server:
    configMode: nacos
    appName: xxxxx
  #  如果server.configMode eq local 的时候才会读取到这里的配置信息.
...
<p>还有其他的配置方式以及配置内容的详解，请参考：<a href="https://dromara.org/zh-cn/docs/hmily/config.html" target="_blank" rel="noopener noreferrer">https://dromara.org/zh-cn/docs/hmily/config.html<ExternalLinkIcon/></a></p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public interface HelloService {
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>@FeignClient(value = "helle-service")
...
<h2 id="下一个版本" tabindex="-1"><a class="header-anchor" href="#下一个版本" aria-hidden="true">#</a> 下一个版本</h2>
<ul>
...
<li>gitee：<a href="https://gitee.com/dromara/hmily" target="_blank" rel="noopener noreferrer">https://gitee.com/dromara/hmily<ExternalLinkIcon/></a></li>
