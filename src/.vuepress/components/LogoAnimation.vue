...
const anim_data = {
  domArr: [
    ...
    },
    {
      widthStr: '4vw',
      backgroundColorStr: '',
      backgroundImageStr: "url('/assets/img/logo-animation/cubic.png')",
      topStr: 'calc(50% - 1vw)',
      rightStr: '',
      bottomStr: '',
    ...
    },
    {
      ...
      backgroundColorStr: '',
      backgroundImageStr:
        "url('/assets/img/logo-animation/open-giteye-api.png')",
      topStr: 'calc(50% - 14vw)',
      rightStr: 'calc(50% - 2vw)',
      bottomStr: '',
      leftStr: '',
      className: 'e-square',
      parentClassName: 'effect-box',
    ...
    },
    {
      ...
      topStr: '',
      rightStr: 'calc(50% - 18vw)',
      bottomStr: 'calc(50% - 19vw)',
      leftStr: '',
      className: 'e-square',
      parentClassName: 'effect-box',
      opacity: 0.2,
